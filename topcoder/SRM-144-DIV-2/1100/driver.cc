...
vector <int>	ductLength;
		...
		std::cout << "input for test: " << fromJunction << ", " << toJunction << ", " << ductLength << std::endl;
		std::cout.flush();
	...
	std::cout << "1.." << (__pass + __fail) << std::endl
		  ...
		  << "# failed: \033[1;33m" << __fail << "\033[0m" << std::endl;

	if (__fail == 0)
	{
		std::cout << std::endl
			  << "\033[1;32mNice!\033[0m DON'T FORGET TO COMPILE REMOTELY BEFORE SUBMITTING!" << std::endl;
	}
